...
public partial class InputEntity {
    ...
    public Lockstep.Core.Components.Input.ActorIdComponent actorId { get { return (Lockstep.Core.Components.Input.ActorIdComponent)GetComponent(InputComponentsLookup.ActorId); } }
    ...
    public void AddActorId(byte newValue) {
        ...
        var component = (Lockstep.Core.Components.Input.ActorIdComponent)CreateComponent(index, typeof(Lockstep.Core.Components.Input.ActorIdComponent));
