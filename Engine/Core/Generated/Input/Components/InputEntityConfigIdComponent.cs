...
public partial class InputEntity {
    ...
    public Lockstep.Core.Components.Input.EntityConfigIdComponent entityConfigId { get { return (Lockstep.Core.Components.Input.EntityConfigIdComponent)GetComponent(InputComponentsLookup.EntityConfigId); } }
    ...
    public void AddEntityConfigId(int newValue) {
        ...
        var component = (Lockstep.Core.Components.Input.EntityConfigIdComponent)CreateComponent(index, typeof(Lockstep.Core.Components.Input.EntityConfigIdComponent));
