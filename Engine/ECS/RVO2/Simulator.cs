    ...
    public class Simulator
    {
        ...
        public int addObstacle(IList<Vector2> vertices)
        {
            ...
            for (int i = 0; i < vertices.Count; ++i)
            {
                ...
                {
                    obstacle.convex_ = (RVOMath.leftOf(vertices[(i == 0 ? vertices.Count - 1 : i - 1)], vertices[i], vertices[(i == vertices.Count - 1 ? 0 : i + 1)]) >= F64.C0);
                }
         ...
         */
        public bool queryVisibility(Vector2 point1, Vector2 point2, Fix64 radius)
        {
