...
public partial class GameEntity {
    ...
    public Simulation.State.Game.PositionComponent position { get { return (Simulation.State.Game.PositionComponent)GetComponent(GameComponentsLookup.Position); } }
    ...
    public void AddPosition(BEPUutilities.Vector2 newValue) {
        ...
        var component = (Simulation.State.Game.PositionComponent)CreateComponent(index, typeof(Simulation.State.Game.PositionComponent));
