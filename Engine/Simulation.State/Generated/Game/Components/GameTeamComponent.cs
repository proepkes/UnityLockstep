...
public partial class GameEntity {
    ...
    public Simulation.State.Game.TeamComponent team { get { return (Simulation.State.Game.TeamComponent)GetComponent(GameComponentsLookup.Team); } }
    ...
    public void AddTeam(byte newValue) {
        ...
        var component = (Simulation.State.Game.TeamComponent)CreateComponent(index, typeof(Simulation.State.Game.TeamComponent));
