...
public partial class GameEntity {
    ...
    public Simulation.State.Game.DestinationComponent destination { get { return (Simulation.State.Game.DestinationComponent)GetComponent(GameComponentsLookup.Destination); } }
    ...
    public void AddDestination(BEPUutilities.Vector2 newValue) {
        ...
        var component = (Simulation.State.Game.DestinationComponent)CreateComponent(index, typeof(Simulation.State.Game.DestinationComponent));
