...
public partial class GameEntity {
    ...
    public Simulation.State.Game.BackupComponent backup { get { return (Simulation.State.Game.BackupComponent)GetComponent(GameComponentsLookup.Backup); } }
    ...
    public void AddBackup(uint newLocalEntityId, uint newTick) {
        ...
        var component = (Simulation.State.Game.BackupComponent)CreateComponent(index, typeof(Simulation.State.Game.BackupComponent));
