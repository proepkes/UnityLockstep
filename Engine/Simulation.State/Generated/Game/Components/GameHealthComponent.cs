...
public partial class GameEntity {
    ...
    public Simulation.State.Game.HealthComponent health { get { return (Simulation.State.Game.HealthComponent)GetComponent(GameComponentsLookup.Health); } }
    ...
    public void AddHealth(int newValue) {
        ...
        var component = (Simulation.State.Game.HealthComponent)CreateComponent(index, typeof(Simulation.State.Game.HealthComponent));
