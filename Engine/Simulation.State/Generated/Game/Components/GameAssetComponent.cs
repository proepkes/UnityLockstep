...
public partial class GameEntity {
    ...
    public Simulation.State.Game.AssetComponent asset { get { return (Simulation.State.Game.AssetComponent)GetComponent(GameComponentsLookup.Asset); } }
    ...
    public void AddAsset(string newName) {
        ...
        var component = (Simulation.State.Game.AssetComponent)CreateComponent(index, typeof(Simulation.State.Game.AssetComponent));
