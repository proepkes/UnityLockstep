...
public partial class GameEntity {
    ...
    public Simulation.State.Game.MaxSpeedComponent maxSpeed { get { return (Simulation.State.Game.MaxSpeedComponent)GetComponent(GameComponentsLookup.MaxSpeed); } }
    ...
    public void AddMaxSpeed(FixMath.NET.Fix64 newValue) {
        ...
        var component = (Simulation.State.Game.MaxSpeedComponent)CreateComponent(index, typeof(Simulation.State.Game.MaxSpeedComponent));
