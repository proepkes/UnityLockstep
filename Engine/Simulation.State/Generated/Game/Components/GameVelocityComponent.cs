...
public partial class GameEntity {
    ...
    public Simulation.State.Game.VelocityComponent velocity { get { return (Simulation.State.Game.VelocityComponent)GetComponent(GameComponentsLookup.Velocity); } }
    ...
    public void AddVelocity(BEPUutilities.Vector2 newValue) {
        ...
        var component = (Simulation.State.Game.VelocityComponent)CreateComponent(index, typeof(Simulation.State.Game.VelocityComponent));
