...
public partial class InputEntity {
    ...
    public Simulation.State.Input.CoordinateComponent coordinate { get { return (Simulation.State.Input.CoordinateComponent)GetComponent(InputComponentsLookup.Coordinate); } }
    ...
    public void AddCoordinate(BEPUutilities.Vector2 newValue) {
        ...
        var component = (Simulation.State.Input.CoordinateComponent)CreateComponent(index, typeof(Simulation.State.Input.CoordinateComponent));
