...
public partial class InputEntity {
    ...
    public Simulation.State.Input.SelectionComponent selection { get { return (Simulation.State.Input.SelectionComponent)GetComponent(InputComponentsLookup.Selection); } }
    ...
    public void AddSelection(uint[] newEntityIds) {
        ...
        var component = (Simulation.State.Input.SelectionComponent)CreateComponent(index, typeof(Simulation.State.Input.SelectionComponent));
