...
public partial class InputEntity {
    ...
    public Simulation.State.Input.TickComponent tick { get { return (Simulation.State.Input.TickComponent)GetComponent(InputComponentsLookup.Tick); } }
    ...
    public void AddTick(uint newValue) {
        ...
        var component = (Simulation.State.Input.TickComponent)CreateComponent(index, typeof(Simulation.State.Input.TickComponent));
