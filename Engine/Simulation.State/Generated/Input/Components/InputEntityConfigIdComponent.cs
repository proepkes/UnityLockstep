...
public partial class InputEntity {
    ...
    public Simulation.State.Input.EntityConfigIdComponent entityConfigId { get { return (Simulation.State.Input.EntityConfigIdComponent)GetComponent(InputComponentsLookup.EntityConfigId); } }
    ...
    public void AddEntityConfigId(int newValue) {
        ...
        var component = (Simulation.State.Input.EntityConfigIdComponent)CreateComponent(index, typeof(Simulation.State.Input.EntityConfigIdComponent));
