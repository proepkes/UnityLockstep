...
public partial class GameStateContext {
    ...
    public Simulation.State.GameState.HashCodeComponent hashCode { get { return hashCodeEntity.hashCode; } }
    public bool hasHashCode { get { return hashCodeEntity != null; } }

    public GameStateEntity SetHashCode(long newValue) {
        if (hasHashCode) {
            throw new Entitas.EntitasException("Could not set HashCode!\n" + this + " already has an entity with Simulation.State.GameState.HashCodeComponent!",
...
public partial class GameStateEntity {
    ...
    public Simulation.State.GameState.HashCodeComponent hashCode { get { return (Simulation.State.GameState.HashCodeComponent)GetComponent(GameStateComponentsLookup.HashCode); } }
    ...
    public void AddHashCode(long newValue) {
        ...
        var component = (Simulation.State.GameState.HashCodeComponent)CreateComponent(index, typeof(Simulation.State.GameState.HashCodeComponent));
