...
namespace Simulation.Behaviour.GameState
{
    public class OnNewPredictionCreateBackup : ReactiveSystem<GameStateEntity>
    {
        ...
        public OnNewPredictionCreateBackup(Contexts contexts, ServiceContainer serviceContainer) : base(contexts.gameState)
        {
            ...
            _snapshotIndexService = serviceContainer.Get<ISnapshotIndexService>();
        ...
        {                                              
            ...
            _logger.Trace(() => "New backup for " + currentTick + "(" + _activeActors.count + " actors, " + _activeEntities.count + " entities)");
        }
    }
}
