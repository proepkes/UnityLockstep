...
public partial class InputEntity {
    ...
    public Lockstep.Core.Components.Input.TickComponent tick { get { return (Lockstep.Core.Components.Input.TickComponent)GetComponent(InputComponentsLookup.Tick); } }
    ...
    public void AddTick(uint newValue) {
        ...
        var component = (Lockstep.Core.Components.Input.TickComponent)CreateComponent(index, typeof(Lockstep.Core.Components.Input.TickComponent));
