...
public partial class GameEntity {
    ...
    public Lockstep.Core.Components.Game.VelocityComponent velocity { get { return (Lockstep.Core.Components.Game.VelocityComponent)GetComponent(GameComponentsLookup.Velocity); } }
    ...
    public void AddVelocity(BEPUutilities.Vector2 newValue) {
        ...
        var component = (Lockstep.Core.Components.Game.VelocityComponent)CreateComponent(index, typeof(Lockstep.Core.Components.Game.VelocityComponent));
