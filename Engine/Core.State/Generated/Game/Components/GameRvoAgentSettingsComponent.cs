...
public partial class GameEntity {
    ...
    public void AddRvoAgentSettings(BEPUutilities.Vector2 newPreferredVelocity, FixMath.NET.Fix64 newNeighborDist, int newMaxNeighbors, System.Collections.Generic.IList<System.Collections.Generic.KeyValuePair<FixMath.NET.Fix64, GameEntity>> newAgentNeighbors) {
    ...
    public void ReplaceRvoAgentSettings(BEPUutilities.Vector2 newPreferredVelocity, FixMath.NET.Fix64 newNeighborDist, int newMaxNeighbors, System.Collections.Generic.IList<System.Collections.Generic.KeyValuePair<FixMath.NET.Fix64, GameEntity>> newAgentNeighbors) {
        var index = GameComponentsLookup.RvoAgentSettings;
        var component = (Lockstep.Core.State.Game.RvoAgentSettingsComponent)CreateComponent(index, typeof(Lockstep.Core.State.Game.RvoAgentSettingsComponent));
        component.preferredVelocity = newPreferredVelocity;
        component.neighborDist = newNeighborDist;
